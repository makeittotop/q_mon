...
class Attribute(object):
    ...
    def setValue(self, value):
        ...
        if not self.isValid(value):
            raise TypeError("%s is not a valid value for %s" %
                            (str(value), self.name))
        self.value = value
...
class DateAttribute(Attribute):
    ...
    def setValue(self, value):
        ...
        if not isinstance(value, datetime.datetime):
            raise TypeError("%s is a %s, not a datetime type for %s" %
...
class Element(object):
    ...
    def __setattr__(self, attr, value):
        ...
        if attr in self.MEMBERS:
            ...
            raise AttributeError("%s is not a valid attribute of a %s" %
...
class Assign(Element):
    ...
    def __init__(self, varname, value):
        if not isinstance(varname, str):
            raise TypeError("AssignElement.__init__(): varname %s is not a "
                            "string" % str(varname))
        if not isinstance(value, str):
            raise TypeError("AssignElement.__init__(): value %s is not a "
                            "string" % str(value))
...
class SubtaskMixin(object):
    ...
    def addChild(self, element):
        ...
        if isinstance(element, Task) and element.parent:
            ...
            raise ParentExistsError("%s is already a child of %s" %
                                    (str(element), str(element.parent)))
        else:
    ...
    def spool(self, block=False, owner=None):
        ...
        try:
            result = ModuleEngineClient.spool(
                self.asTcl(), skipLogin=True, block=block, owner=owner)
